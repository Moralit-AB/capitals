...
def create_game_schedule(n_players, n_rounds=5, max_games_per_round=10, max_pairwise_meetings=2):
    """
...
if __name__ == "__main__":
    ...
    n = 11
    schedule, stats = create_game_schedule(n, max_pairwise_meetings=2)
    if schedule:
